                ...
                <div className="w-full h-full flex items-center space-x-6">
                    ...
                    <nav className="w-full h-12 md:h-20 hidden md:flex items-center justify-between text-xs font-semibold font-inter tracking-widest">
                        ...
                        <div className="px-4 h-10 hidden md:flex items-center rounded-full bg-green-800/60 text-amber-100 saturate-50">
                            <Link href="/about" className="px-2 py-2 w-fit h-full flex items-center justify-center">
                                ABOUT
                            </Link>
                            <Link href="/impact" className="px-4 py-2 w-fit h-full flex items-center justify-center">IMPACT</Link>
                            <Link href="/contact" className="px-4 py-2 w-fit h-full flex items-center justify-center">CONTACT</Link>
                        </div>
                        <div className="relative flex items-center space-between">
                            ...
                            <Link href="/category" className="px-4 py-2 w-fit h-full flex items-center justify-center">CROPS</Link>
                            <Link href="/category" className="px-4 py-2 w-fit h-full flex items-center justify-center">SOIL</Link>
                            <Link href="/category" className="px-4 py-2 w-fit h-full flex items-center justify-center">PESTS/DISEASES</Link>
                            <Link href="/category" className="px-4 py-2 w-fit h-full flex items-center justify-center">ANIMALS</Link>
                            <Link href="/category" className="px-4 py-2 w-fit h-full flex items-center justify-center">AQUACULTURE</Link>
                            <Link href="/category" className="px-4 py-2 w-fit h-full flex items-center justify-center">EPICULTURE</Link>
                        </div>
                    </nav>
                </div>
