  ...
  return (
    <div className="flex flex-col space-y-2 md:space-y-10">
      <div className="w-full flex flex-col md:flex-row space-y-10 md:space-y-0 md:space-x-6">
          ...
          <div className="space-y-3">
            <div className="text-base md:text-lg font-medium space-y-4 leading-7">
              ...
              <p>Rolex, synonymous with luxury and prestige, has carved a niche in the watchmaking world. Today, we delve into the iconic Rolex Oyster Perpetual Datejust, a timepiece that embodies the brands core values of quality, heritage, and enduring style.</p>
              <h3>Unmatched Craftsmanship:</h3>
              <p>The Datejust boasts a robust 904L stainless steel construction, renowned for its superior corrosion resistance. The watch feels solid and meticulously crafted, a testament to Rolexs commitment to exceptional build quality.</p>
            </div>
      ...
      <div className="md:text-lg text-gray-600  space-y-2">
        ...
        <p>The design language is one of understated elegance. The classic round case, the signature fluted bezel, and the easily recognizable Rolex crown contribute to the watchs enduring appeal. The watch transcends fleeting trends, offering a sophisticated aesthetic that remains relevant for decades.</p>
        ...
        <p>
            ...
            Briefly touch upon the brands after-sales service, known for its quality and exclusivity.
